        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    id="judul_berita" name="judul_berita" placeholder="Judul Berita" value="{{ old('judul_berita', $berita->judul_berita)}}">
                    @error('judul_berita')
                ...
                <div class="form-group">
                    ...
                    <select class="costum-select rounded-0" id="kategori_id" name="kategori_id">
            ...
            <div class="card-footer">
                <button type="sumbit" class="btn btn-primary">Update Berita</button>
            </div>
            </form>
        </div>
    </div>
